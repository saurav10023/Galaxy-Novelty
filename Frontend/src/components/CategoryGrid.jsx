...
// 64x64 viewBox, #14171C stroke, #2F5DFF tinted fill fills.
...
const MobileGlyph = () => (
  <svg viewBox="0 0 64 64" className="w-14 h-14" fill="none">
    ...
    <rect x="22" y="13" width="20" height="34" rx="1.5" fill="#2F5DFF" opacity="0.12" />
...
const HeadphoneGlyph = () => (
  <svg viewBox="0 0 64 64" className="w-14 h-14" fill="none">
    ...
    <rect x="9" y="32" width="10" height="18" rx="4" fill="#2F5DFF" opacity="0.12" stroke="#14171C" strokeWidth="2.5" />
    <rect x="45" y="32" width="10" height="18" rx="4" fill="#2F5DFF" opacity="0.12" stroke="#14171C" strokeWidth="2.5" />
...
const ChargerGlyph = () => (
  <svg viewBox="0 0 64 64" className="w-14 h-14" fill="none">
    ...
    <rect x="28" y="24" width="8" height="10" fill="#2F5DFF" opacity="0.12" stroke="#14171C" strokeWidth="2.5" />
    <path d="M34 34 26 46h6l-2 12 12-16h-6l2-8Z" fill="#2F5DFF" stroke="#14171C" strokeWidth="1.8" strokeLinejoin="round" />
  </svg>
);
...
const PowerBankGlyph = () => (
  <svg viewBox="0 0 64 64" className="w-14 h-14" fill="none">
    ...
    <rect x="21" y="18" width="22" height="28" rx="2" fill="#2F5DFF" opacity="0.12" />
    <path d="M35 22 27 34h5l-1 10 10-14h-5l1-8Z" fill="#2F5DFF" stroke="#14171C" strokeWidth="1.6" strokeLinejoin="round" />
  </svg>
);
    ...
    <section className="bg-[#F3F4F1]">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 md:py-20">
        <div className="mb-10 max-w-lg">
          <p className="font-mono text-[11px] tracking-[0.18em] uppercase text-[#6B7280] mb-3">
            Shop by category
          </p>
        ...
        <div ref={ref} className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {CATEGORIES.map(({ key, label, tagline, glyph: Glyph }, i) => (
            <Link
              ...
              className="group relative rounded-2xl bg-white border border-[#E1E3DD] p-6 flex flex-col justify-between min-h-[220px] transition-all duration-300 ease-out hover:-translate-y-1 hover:border-[#14171C] hover:shadow-[0_20px_40px_-24px_rgba(20,23,28,0.35)]"
              style={{
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="w-8 h-8 rounded-full bg-[#F6F7F3] flex items-center justify-center text-[#14171C] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <ArrowIcon />
                </span>
              </div>

              <div className="mt-6">
                <h3 className="font-display text-[17px] font-semibold text-[#14171C]">{label}</h3>
