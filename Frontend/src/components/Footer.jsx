...
// (font-display wordmark, font-mono labels, #F5590A accent), inverted to a
...
const Footer = () => {
  return (
    <footer className="bg-[#14171C] text-white mt-20 border-t-2 border-[#F5590A]">
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <Link to="/" className="flex items-center gap-2.5 shrink-0">
            ...
            <span className="font-display text-[16px] font-semibold tracking-tight leading-none">
              GALAXY<span className="text-[#FF8A3D]"> NOVELTY</span>
            </span>
          </Link>
          ...
          <nav className="flex flex-wrap items-center gap-x-6 gap-y-2">
            {CATEGORY_LINKS.map((c) => (
              <Link
                ...
                className="text-[13px] text-[#9CA0A6] hover:text-[#FF8A3D] transition-colors duration-150"
              >
                {c.label}
              </Link>
            ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 mt-6 pt-5 border-t border-white/10">
          ...
          <div className="flex items-center gap-5">
            <Link to="/privacy" className="text-[11.5px] text-[#6B6F76] hover:text-[#FF8A3D] transition-colors duration-150">
              Privacy
            </Link>
            <Link to="/terms" className="text-[11.5px] text-[#6B6F76] hover:text-[#FF8A3D] transition-colors duration-150">
              Terms
            </Link>
          </div>
        </div>
